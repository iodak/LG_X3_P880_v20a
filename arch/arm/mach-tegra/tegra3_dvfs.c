...
static struct dvfs cpu_dvfs_table[] = {
	...
	CPU_DVFS("cpu_g",  4, 0, MHZ,   1,   1,   1,   1, 460, 460, 460, 550, 550, 550, 550,  680,  680,  680,  680,  680,  680,  680,  820,  820,  970,  970,  970, 1040, 1040, 1080, 1080, 1150, 1150, 1200, 1200, 1240, 1240, 1280, 1280, 1320, 1320, 1360, 1500, 1600),
	CPU_DVFS("cpu_g",  4, 1, MHZ,   1,   1,   1,   1, 480, 480, 480, 650, 650, 650, 650,  780,  780,  780,  780,  780,  780,  780,  990,  990, 1040, 1040, 1040, 1100, 1100, 1200, 1200, 1250, 1250, 1300, 1300, 1330, 1330, 1360, 1360, 1400, 1400, 1500, 1540, 1600),
	CPU_DVFS("cpu_g",  4, 2, MHZ,   1,   1,   1,   1, 520, 520, 520, 700, 700, 700, 700,  860,  860,  860,  860,  860,  860,  860, 1050, 1050, 1150, 1150, 1150, 1200, 1200, 1280, 1280, 1300, 1300, 1340, 1340, 1380, 1380, 1500, 1520, 1520, 1520, 1590, 1700),
	CPU_DVFS("cpu_g",  4, 3, MHZ,   1,   1,   1,   1, 550, 550, 550, 770, 770, 770, 770,  910,  910,  910,  910,  910,  910,  910, 1150, 1150, 1230, 1230, 1230, 1280, 1280, 1330, 1330, 1370, 1370, 1400, 1400, 1500, 1520, 1520, 1520, 1520, 1590, 1700),
...
static struct dvfs cpu_0_dvfs_table[] = {
	/* Cpu voltages (mV):	      750, 762, 775, 787, 800, 825, 837, 850, 862,  875,  887,  900,  912,  916,  925,  937,  950,  962,  975,  987, 1000, 1007, 1012, 1025, 1037, 1050, 1062, 1075, 1087, 1100, 1112, 1125, 1137, 1150, 1162, 1175, 1187, 1200, 1212, 1237*/
#ifdef CONFIG_CPU_OVERCLOCK
	CPU_DVFS("cpu_0",  4, 0, MHZ,   1,   1,   1, 475, 475, 475, 475, 640, 640,  640,  760,  760,  760,  760,  860,  860,  860,  860,  860, 1000, 1000, 1000, 1000, 1100, 1100, 1100, 1100, 1200, 1200, 1200, 1200, 1200, 1300, 1300, 1300, 1300, 1400, 1400, 1400, 1500, 1600),
	CPU_DVFS("cpu_0",  4, 1, MHZ,   1, 475, 475, 475, 475, 640, 640, 640, 760,  760,  760,  860,  860,  860,  860,  860, 1000, 1000, 1000, 1100, 1100, 1100, 1100, 1100, 1200, 1200, 1200, 1300, 1300, 1300, 1300, 1400, 1400, 1400, 1400, 1400, 1400, 1500, 1540, 1600),
	CPU_DVFS("cpu_0",  4, 2, MHZ, 475, 475, 475, 640, 640, 640, 760, 760, 760,  860,  860,  860, 1000, 1000, 1000, 1000, 1000, 1100, 1100, 1200, 1200, 1200, 1200, 1200, 1300, 1300, 1300, 1300, 1400, 1400, 1400, 1400, 1400, 1500, 1520, 1520, 1520, 1590, 1700),
	CPU_DVFS("cpu_0",  4, 3, MHZ, 475, 475, 640, 640, 640, 760, 760, 860, 860,  860,  860, 1000, 1000, 1000, 1100, 1100, 1100, 1100, 1200, 1200, 1200, 1200, 1300, 1300, 1300, 1300, 1400, 1400, 1400, 1400, 1400, 1500, 1520, 1520, 1520, 1520, 1590, 1700),
#else
...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("vde",    0, 1, KHZ,        1, 228000, 332000, 416000, 484000,  520000,  520000,  520000,  520000),
	CORE_DVFS("mpe",    0, 1, KHZ,        1, 234000, 332000, 416000, 484000,  520000,  520000,  520000,  520000),
	CORE_DVFS("2d",     0, 1, KHZ,        1, 267000, 332000, 416000, 484000,  520000,  520000,  520000,  520000),
	CORE_DVFS("epp",    0, 1, KHZ,        1, 267000, 332000, 416000, 484000,  520000,  520000,  520000,  520000),
	CORE_DVFS("3d",     0, 1, KHZ,        1, 234000, 332000, 416000, 484000,  520000,  520000,  520000,  520000),
	CORE_DVFS("3d2",    0, 1, KHZ,        1, 234000, 332000, 416000, 484000,  520000,  520000,  520000,  520000),
	CORE_DVFS("se",     0, 1, KHZ,        1, 267000, 332000, 416000, 484000,  520000,  520000,  520000,  520000),

	CORE_DVFS("vde",    1, 1, KHZ,   200000, 228000, 332000, 416000, 484000,  520000,  520000,  520000,  520000),
	CORE_DVFS("mpe",    1, 1, KHZ,   200000, 234000, 332000, 416000, 484000,  520000,  520000,  520000,  520000),
	CORE_DVFS("2d",     1, 1, KHZ,   200000, 267000, 332000, 416000, 484000,  520000,  520000,  520000,  520000),
	CORE_DVFS("epp",    1, 1, KHZ,   200000, 267000, 332000, 416000, 484000,  520000,  520000,  520000,  520000),
	CORE_DVFS("3d",     1, 1, KHZ,   200000, 234000, 332000, 416000, 484000,  520000,  520000,  520000,  520000),
	CORE_DVFS("3d2",    1, 1, KHZ,   200000, 234000, 332000, 416000, 484000,  520000,  520000,  520000,  520000),
	CORE_DVFS("se",     1, 1, KHZ,   200000, 267000, 332000, 416000, 484000,  520000,  520000,  520000,  520000),
#else
...
#endif
#ifdef CONFIG_GPU_OVERCLOCK
	CORE_DVFS("cbus",   0, 1, KHZ,        1, 228000, 332000, 416000, 484000,  520000,  520000,  520000,  520000),
	CORE_DVFS("cbus",   1, 1, KHZ,   200000, 228000, 332000, 416000, 484000,  520000,  520000,  520000,  520000),
#else
